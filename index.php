    ...
    <div id="main">
        ...
        <div class="jumbotron bg-transparent mb-0 pt-3 radius-0">
            <div class="">
                <div class="row">
                    <div class="col-xl-8">
                        <h1 class="display-1 bold color_white content__title"><span class="color_danger">CTF</span><span class="color_white">Makers</span><span class="vim-caret">&nbsp;</span></h1>
                        <h1 class="display-1 bold color_white content__title2">HACKERS</h1>
